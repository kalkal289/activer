                ...
                <div class="all-container">
                            ...
                            <div class="center-container">
                                <div class="center-contents-area">
                                    <form class="create-form" action="{{ route('updateMain', ['main' => $main->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input id="title" class="create-main-title" type="text" name="main[title]" placeholder="タイトル（必須）" value="{{ (old('main.title')) ? old('main.title') : $main->title }}">
                    ...
                    <aside id="side-bar" class="side-bar">
                        ...
                        <div class="guide-container">
                            ...
                            <h4 class="guide-sub-title">メインコンテンツ編集方法</h4>
                            <ul class="guide-list">
