                        ...
                        <div class="center-area">
                            ...
                            @if($user->id == Auth::id())
                                <div class="contents-create-btn-area">
                                    <a class="main-create-btn sm-text" href="{{ route('createMain') }}"><i class="fa-solid fa-star contents-create-icon-main contents-create-icon"></i> メインコンテンツを作成する</a>
                                    <a class="edit-category-btn sm-text" href="{{ route('editCategory') }}">マイカテゴリー設定</a>
                                </div>
                            @endif
